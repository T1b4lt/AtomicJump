...
func place_objects():
	# Place 1 to 5 coins and 0 or 1 key in the platform
	# aux_placeholders is an array of Node2D objects, so coins and keys can be placed in any of them (same position)
